...
class LibvirtConnTestCase(test.TestCase):
    ...
    def test_get_connector(self):
        ...
        self.flags(my_ip=ip)
        def fake_execute(*args, **kwargs):
            return "InitiatorName=%s" % initiator, None

        self.stubs.Set(fake_libvirt_utils, 'execute', fake_execute)
    ...
    def test_get_instance_disk_info_works_correctly(self):
        ...
        self.mox.StubOutWithMock(fake_libvirt_utils, "execute")
        fake_libvirt_utils.execute('qemu-img', 'info', '/test/disk.local').\
            AndReturn((ret, ''))
